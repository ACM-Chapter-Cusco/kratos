...
const Simulador = () => {
  ...
  return (
    <div className="flex h-auto w-[22rem] flex-col rounded-[0.625rem] bg-[#0F1317] text-[#95A8C1] opacity-90 shadow-3xl shadow-black sm:w-[80%] md:h-[31.5rem] md:flex-row lg:w-[56rem]">
      {/* editor */}
      <div className="h-auto w-full border-b-2 border-[#292C2F] p-[1.37rem] md:h-full md:w-[60%] md:border-b-0 md:border-r-2">
      ...
      <div className="h-auto w-full bg-[#090E12] p-[1.37rem] pb-[3rem] max-md:rounded-b-xl md:h-full md:w-[40%] md:rounded-r-xl">
        ...
        >
          <div className="w-flull flex cursor-pointer items-center gap-x-2 rounded-md bg-green-500 px-[1.25rem] py-[0.2rem] text-white hover:bg-green-600 md:rounded-xl md:py-[0.4rem]">
        ...
        {/* Result */}
        {isRunning && (
          <div className="flex flex-col gap-y-[0.7rem] font-Code text-[1rem] font-[600] md:text-[1.125rem]">
            <p className="text-green-500">Finished in 6 ms:</p>
