...
const About = () => {
  return (
    <>
      {/* Desktop */}
      <div className="text-gray relative flex w-full flex-col bg-orange-900 max-lg:p-[1.25rem] max-md:hidden sm:w-[640px] sm:bg-purple-900 md:w-[768px] md:gap-y-5 md:bg-sky-900 lg:w-[1024px] lg:gap-y-10 lg:bg-red-900 xl:w-[1280px] xl:bg-yellow-900">
        {/* Top part */}
      ...
      {/* mobile */}
      <div className="text-gray relative flex w-full flex-col bg-orange-900 max-lg:p-[1.25rem] sm:w-[640px] sm:bg-purple-900 md:hidden md:w-[768px] md:gap-y-5 md:bg-sky-900 lg:w-[1024px] lg:gap-y-10 lg:bg-red-900 xl:w-[1280px] xl:bg-yellow-900">
        {/* Top part */}
