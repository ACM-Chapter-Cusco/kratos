...
export const ArticlesTeams = ({ children, color, content, links }) => {
  ...
  return (
    <article
      className={`${style.acmTeams_hover} font-Opensans text-white-azul flex flex-col justify-between items-ceter pt-[33px]  bg-[#0F1317] shadow h-[245px] w-[336px] rounded-xl py-[16px] px-[30px] relative drop-shadow-[0_0_0.3rem_#000307] transition-all duration-300`}
